...
```
������ main.gd          # G?��wna logika gry, zarz?dzanie wynikiem
������ Main.tscn        # G?��wna scena z poziomem
������ player.gd        # Sterowanie gracza i fizyka
������ player.tscn      # Scena gracza
������ platform.gd      # Logika generowania platform
������ platform.tscn    # Scena platformy
������ coin.gd          # Logika monet
������ coin.tscn        # Scena monety
������ enemy.gd         # AI przeciwnika
������ enemy.tscn       # Scena przeciwnika
������ camera_shake.gd  # Efekt trz?sienia kamery
